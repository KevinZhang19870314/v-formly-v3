...
declare const _sfc_main: import("vue").DefineComponent<{
    ...
    ElDatePicker: import("element-plus/es/utils").SFCWithInstall<import("vue").DefineComponent<{
        type: import("element-plus/es/utils").EpPropFinalized<(new (...args: any[]) => "date" | "year" | "month" | "dates" | "week" | "datetime" | "datetimerange" | "daterange" | "monthrange") | (() => import("element-plus/es/components/date-picker/src/date-picker.type").IDatePickerType) | ((new (...args: any[]) => "date" | "year" | "month" | "dates" | "week" | "datetime" | "datetimerange" | "daterange" | "monthrange") | (() => import("element-plus/es/components/date-picker/src/date-picker.type").IDatePickerType))[], unknown, unknown, "date", boolean>;
        disabledDate: {
        ...
        type: import("element-plus/es/utils").EpPropMergeType<(new (...args: any[]) => "date" | "year" | "month" | "dates" | "week" | "datetime" | "datetimerange" | "daterange" | "monthrange") | (() => import("element-plus/es/components/date-picker/src/date-picker.type").IDatePickerType) | ((new (...args: any[]) => "date" | "year" | "month" | "dates" | "week" | "datetime" | "datetimerange" | "daterange" | "monthrange") | (() => import("element-plus/es/components/date-picker/src/date-picker.type").IDatePickerType))[], unknown, unknown>;
