...
const ce = "form-value-change", ee = "form-error-change", de = /* @__PURE__ */ N({
  ...
  setup(t) {
    ...
    function l() {
      ...
      const { visibleIf: c } = je(), { appContext: d } = $();
...
const Me = { class: "v__formly" }, Fe = { name: "v-formly" }, Se = /* @__PURE__ */ N({
  ...Fe,
  props: {
    modelValue: null,
  ...
  setup(t, { expose: e, emit: a }) {
    ...
    function v() {
      o.layout = i.layout, n = Object.assign({}, n, i.meta), o.meta = n, o.formData = Object.assign({}, i.modelValue), u(o.formData, i.meta.properties), o.context = new Ve(), o.validate = new Ae(p, o);
    }
    function u(g, E) {
...
}), De = { class: "v__label-text" }, Be = {
  key: 0,
  class: "v__optional"
}, Re = ["innerHTML"], Ue = {
  key: 1,
  class: "ant-form-item-explain-error"
}, Le = { name: "v-wrapper" }, L = /* @__PURE__ */ N({
  ...Le,
  props: {
    id: null,
    show: { type: Boolean },
  ...
  setup(t) {
    ...
    return (f, x) => {
      ...
      return _(), k(h, {
        ...
        label: m(() => [
          ge("span", De, W(t.meta.title), 1),
          s(r).optional || s(o) ? (_(), D("span", Be, [
            J(W(s(r).optional) + " ", 1),
            s(o) ? (_(), k(C, {
              key: 0,
              title: s(o).text,
...
const He = /* @__PURE__ */ N({
  ...
  setup(t) {
    const e = t, { slotsName: a } = ae(e.meta), i = A("state"), { appContext: n } = $(), r = new ze(n, i, e.id, e.meta), o = b(() => r.ui.value || {}), l = b(() => Object.assign({}, i.ui.grid, o.value.grid).gutter), p = b(() => i.layout);
    function c(u) {
...
const Ke = /* @__PURE__ */ N({
  ...
  setup(t) {
    const e = t, a = A("state"), { appContext: i } = $(), n = new Ge(i, a, e.id, e.meta), { bindings: r } = R(Object.keys(be.props), n.ui), o = b(() => n.ui.value || {}), l = b({
      get() {
        return n.value;
      },
      set(c) {
...
function Qe(t) {
  U(t, "v-object", He), U(t, "v-string", Te), U(t, "v-boolean", Ke), U(t, "v-autocomplete", qe), U(t, "v-checkbox", We), U(t, "v-date", Je), U(t, "v-time", Ye);
}
const Xe = [Se, L], Ze = function(t, e) {
  return t.config.globalProperties.emitter = we(), Xe.forEach((a) => {
    t.component(a.name, a);
  }), Qe(t), t.config.globalProperties.$VFORMLY_OPTIONS = e, t;
}, st = {
  install: Ze
};
export {
