import{_ as n,o as s,c as a,d as t}from"./app.5b6a6178.js";const o={},p=t(`<h1 id="名词解释" tabindex="-1"><a class="header-anchor" href="#名词解释" aria-hidden="true">#</a> 名词解释</h1><h2 id="meta" tabindex="-1"><a class="header-anchor" href="#meta" aria-hidden="true">#</a> meta</h2><p><code>meta</code>在 v-formly-v3 中代表的是标准的 JSON Schema 和嵌套的<code>ui</code>结合的结构。例如如下结构：</p><div class="language-json" data-ext="json"><pre class="language-json"><code><span class="token punctuation">{</span>
